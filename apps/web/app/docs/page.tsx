    ...
    <main>
      <section className="home-hero">
        ...
        <div className="quick-start">
          ...
          <pre>
            <code>{`import { getIcon } from "${baseUrl}/octicons/latest";

const icon = getIcon("mark-github", 24);

console.log(icon.fileName);`}</code>
          </pre>
        </div>
      </section>
        ...
        <div className="info-panel-grid">
          <article className="info-panel">
            ...
            <div className="panel-body">
              ...
              <pre>
                <code>{`import { getIcon } from "${baseUrl}/simple-icons/latest";`}</code>
              </pre>
            </div>
          </article>
          ...
          <article className="info-panel">
            ...
            <div className="panel-body">
              ...
              <pre>
                <code>{`const github = getIcon("github");

console.log(github.hex);`}</code>
              </pre>
            </div>
          </article>
        </div>
        ...
        <div className="info-panel-grid">
          <article className="info-panel">
            ...
            <div className="panel-body">
              ...
              <pre>
                <code>{`const results = searchIcons("github");`}</code>
              </pre>
            </div>
          </article>
      ...
      <section>
        ...
        <div className="info-panel-grid">
          <article className="info-panel">
            ...
            <div className="panel-body">
              <code>{`${baseUrl}/font-awesome/latest`}</code>
          ...
          <article className="info-panel">
            ...
            <div className="panel-body">
              <code>{`${baseUrl}/font-awesome/7.3.1`}</code>
      ...
      <section>
        ...
        <div className="info-panel">
          ...
          <div className="panel-body">
            ...
            <pre>
              <code>{`const icon = getIcon("mark-github", 24);
//                     ^ icon name autocomplete
//                                    ^ size autocomplete`}</code>
            </pre>
          </div>
        </div>
      </section>
